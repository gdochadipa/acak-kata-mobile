...
Color backgroundColor2 = Color(0xffB983FF);
...
Color primaryTextColor = Color(0xffB983FF);
Color secondaryTextColor = Color(0xff979797);
...
TextStyle headerText1 = GoogleFonts.poppins(fontSize: 24, fontWeight: semiBold);
TextStyle headerText2 = GoogleFonts.poppins(fontSize: 28, fontWeight: regular);
TextStyle headerText3 = GoogleFonts.poppins(fontSize: 16, fontWeight: regular);
